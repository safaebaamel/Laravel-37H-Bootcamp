   <!-- header -->
   <div class="carousel fade-carousel" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-ride="carousel"
            ...
            <div class="item slides active">
                ...
                <div class="hero">
                    <hgroup>
                        ...
                        <h3>Automate Workflow. Reduce Chaos.</h3>
                    </hgroup>
                    <button class="btn btn-hero btn-lg" role="button">Read About Us</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <section id="mainWrapper">
        <div id="services" data-aos="fade-left" data-aos-anchor="#example-anchor" data-aos-offset="500"
            data-aos-duration="500">
            <div class="ServiceInner" data-aos="flip-right">
                <h1> Our Offers </h1>
                <p> This Platform is a result of a brainstorm,<br> Many People look for an application to manage their Employees.<br />
                    That's why EMPLODA!<br /> You'll gain much more time and energy than
                    you think!
                </p>
            </div>
            <div class="service-cards" data-aos="fade-down">
                ...
                <div class="service-card ui">
                    ...
                    <p>When you find yourself needing an advice just post your requirements and receive competitive
                        quotes from specialist nationwide.</p>
                </div>
